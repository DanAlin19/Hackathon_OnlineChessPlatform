    ...
    <section className="min-h-screen pt-8 dark:text-gray-100 dark:bg-slate-900 duration-100">
      ...
      <div className="max-w-3xl mx-auto px-5">
        <div className="text-center">
          <h2>Code A Programc</h2>
          <h5> Share And Subscribe</h5>
        </div>
        <p>
          Lorem ipsum dolor sit amet, consectetur adipisicing elit. Repellendus
          repellat nam doloremque, eos eligendi laborum perferendis
          exercitationem, cupiditate quaerat alias in ex odit dolorem. Corporis
          wwwww wwww
          impedit assumenda nisi dicta hic!
        </p>
      </div>
    </section>
  )
